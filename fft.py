...
def fftTransform(dataPoint, Fs, Time_length):
	...
	x = np.array([p[0] for p in dataPoint])
	y = np.array([p[1] for p in dataPoint])
	z = np.array([p[2] for p in dataPoint])
	...
	return [X_sum_from_0_3Hz_to_15Hz, Y_sum_from_0_3Hz_to_15Hz, Z_sum_from_0_3Hz_to_15Hz, SMV_sum_from_0_3Hz_to_15Hz,
			X_sum_from_0_6Hz_to_2_5Hz, Y_sum_from_0_6Hz_to_2_5Hz, Z_sum_from_0_6Hz_to_2_5Hz, SMV_sum_from_0_6Hz_to_2_5Hz,
			X_sum_domain, Y_sum_domain, Z_sum_domain, SMV_sum_domain,
			X_ratio, Y_ratio, Z_ratio, SMV_ratio]
